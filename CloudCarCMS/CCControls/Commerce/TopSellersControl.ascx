<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="TopSellersControl.ascx.vb" Inherits="CloudCar.CCControls.Commerce.TopSellersControl" %>
        ...
        <div>
            <div class="image">
                <a href="<%# String.Format("/Shop/{0}/{1}.html", Eval("Category.Permalink"), Eval("Permalink"))%>">
                    <img src="<%# String.Format("/images/db/{0}/60/{1}.jpg", Eval("DefaultImageId"), Eval("Name"))%>" alt="Golden Heel" />
                </a>
            </div>
            <div class="name">
                <a href="<%# String.Format("/Shop/{0}/{1}.html", Eval("Category.Permalink"), Eval("Permalink"))%>">
