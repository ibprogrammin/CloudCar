<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CCMasterPages/Email.Master" CodeBehind="PrintOrder.aspx.vb" Inherits="CloudCar.CCAdmin.Commerce.Print.PrintOrder" %>
...
<p style="width: 620px;">Thank you for your order, if you notice any discrepancies with the following details, please contact us at <asp:HyperLink runat="server" ID="hlSupportEmail" />.</p>
...
<asp:DataGrid runat="server" ID="dgOrderItems" Width="100%" AutoGenerateColumns="false" DataKeyField="ID" 
    ...
    <Columns>
        <asp:TemplateColumn HeaderText="Item(s)" ItemStyle-Width="15%">
            <ItemTemplate>
                <asp:Image runat="server" ImageUrl='<%# String.Format("http://{0}/images/db/{1}/60/{2}.jpg",Settings.HostName, Eval("ImageID"), Eval("Name")) %>' style="float: left;" BorderWidth="6" BorderColor="White" /><br />
            </ItemTemplate>
        </asp:TemplateColumn>
...
<table width="100%">
    <tr>
        <td width="60%" valign="top">
            ...
            <p><label>Shipping Information (Company, Service, Fee)</label><br />
            <asp:Label runat="server" ID="lblShipCompany" /> - <asp:Label runat="server" ID="lblShipService" /> - <asp:Label runat="server" ID="lblShipCharge" /></p>
