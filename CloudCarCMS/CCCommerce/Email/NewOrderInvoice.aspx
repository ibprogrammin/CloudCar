<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CCMasterPages/Email.Master" CodeBehind="NewOrderInvoice.aspx.vb" Inherits="CloudCar.CCCommerce.Email.NewOrderInvoice" %>
    ...
    <Columns>
        <asp:TemplateColumn HeaderText="Item(s)" ItemStyle-Width="15%">
            <ItemTemplate>
                ...
                String.Format("http://{0}/images/db/{1}/60/{2}.jpg", Settings.HostName, Eval("ImageID"), Eval("Name")) %>' style="float: left;" BorderWidth="6" BorderColor="White" /><br />
            </ItemTemplate>
        </asp:TemplateColumn>
