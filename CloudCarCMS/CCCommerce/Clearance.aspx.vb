...
Namespace CCCommerce
    ...
    Partial Public Class Clearance
        Inherits CloudCarProductListingPage

        Public Sub New()
            RouteData.Values.Add("permalink", Settings.ClearancePage)
        End Sub
        ...
        Protected Overrides Sub LoadDetails(ByVal Permalink As String)
            ...
            ProductRepeater.DataSource = FilterProducts(ProductController.GetActiveClearanceItems(CurrentDataContext).ToList)
