<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CCMasterPages/Main.Master" CodeBehind="Clearance.aspx.vb" Inherits="CloudCar.CCCommerce.Clearance" %>
...
<asp:Content ContentPlaceHolderID="FirstContentPlaceHolder" runat="server">
    ...
    <section class="store-navigation">
        ...
        <CMS:HeaderImageControl runat="server" Id="HeaderImageControl1" EnableViewState="False" />
