...
Namespace CCContentManagement.ClientForms
    ...
    Partial Public Class GrantsForm
        ...
        '''<summary>
        '''GrantApplicationFileUpload control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents GrantApplicationFileUpload As Global.System.Web.UI.WebControls.FileUpload
