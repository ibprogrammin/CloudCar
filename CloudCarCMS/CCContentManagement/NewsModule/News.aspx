<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CCMasterPages/Main.Master" CodeBehind="News.aspx.vb" Inherits="CloudCar.CCContentManagement.NewsModule.News" %>
...
<asp:Content ContentPlaceHolderID="FirstContentPlaceHolder" runat="server">
    ...
    <CMS:NewsControl runat="server" ID="PageNewsControl" />
