...
Public Interface IRoutableHandler
    Property RequestContext() As RequestContext
End Interface

Public Class RoutableHandler
    Implements IRoutableHandler
    ...
    Public ReadOnly Property BaseUrl() As String
        Get
            Return (RequestContext.HttpContext.Request.Url.GetLeftPart(UriPartial.Authority) & VirtualPathUtility.ToAbsolute("~/"))
        End Get
    End Property

    Public Property RequestContext() As RequestContext Implements IRoutableHandler.RequestContext
